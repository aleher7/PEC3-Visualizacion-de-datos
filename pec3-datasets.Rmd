...
#  pivot_longer(cols = c(total_reservations, cancellations, cancel_rate),
#               names_to = "metric",
#               values_to = "value") %>%
#  pivot_wider(names_from = month_year, values_from = value)
...
hotel_booking_summary_transformed <- hotel_booking_summary %>%
  pivot_wider(
    ...
    values_from = c(total_reservations, cancellations, cancel_rate),
    names_glue = "{.value}_{arrival_date_year}"
  )
